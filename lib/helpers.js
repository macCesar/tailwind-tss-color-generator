...
function shadow(boxShadow) {
	...
	convertedStyles += `'.shadow-xs[platform=ios]': { viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: 1, viewShadowColor: '#88000000' }\n`;
	convertedStyles += `'.shadow-sm[platform=ios]': { viewShadowOffset: { x: 0, y: 1 }, viewShadowRadius: 1, viewShadowColor: '#88000000' }\n`;
	convertedStyles += `'.shadow[platform=ios]': { viewShadowOffset: { x: 0, y: 2 }, viewShadowRadius: 2, viewShadowColor: '#88000000' }\n`;
	convertedStyles += `'.shadow-md[platform=ios]': { viewShadowOffset: { x: 0, y: 4 }, viewShadowRadius: 4, viewShadowColor: '#88000000' }\n`;
	convertedStyles += `'.shadow-lg[platform=ios]': { viewShadowOffset: { x: 0, y: 8 }, viewShadowRadius: 8, viewShadowColor: '#88000000' }\n`;
	convertedStyles += `'.shadow-xl[platform=ios]': { viewShadowOffset: { x: 0, y: 12 }, viewShadowRadius: 12, viewShadowColor: '#88000000' }\n`;
	convertedStyles += `'.shadow-2xl[platform=ios]': { viewShadowOffset: { x: 0, y: 16 }, viewShadowRadius: 16, viewShadowColor: '#88000000' }\n`;
	convertedStyles += `'.shadow-inner[platform=ios]': { viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: null, viewShadowColor: null }\n`;
	convertedStyles += `'.shadow-outline[platform=ios]': { viewShadowOffset: { x: 0, y: 0 }, viewShadowRadius: 2, viewShadowColor: '#88000000' }\n`;
...
function margin(spacing) {
	...
	_.each(objectPosition, (properties, rule) => {
		...
		_.each(spacing, (value, modifier) => {
			...
			convertedStyles += `'.${rule}-${modifier}': {${remove_last_character(sides)} }\n`;
		});
		...
		convertedStyles += `'.${rule}-auto': {${remove_last_character(sides)} }\n`;
